        ...
        drag: function(b, c) {
          ...
          for (var k = d.snapElements.length - 1; k >= 0; k--) {
            ...
            if (e.snapMode != "inner") {
              ...
              p &&
                (c.position.top =
                  d._convertPositionTo("relative", { top: n - d.helperProportions.height, left: 0 }).top -
                  d.margins.top),
      ...
      _doKeyUp: function(a) {
        ...
        if (b.input.val() != b.lastVal)
          try {
            ...
            c &&
              ($.datepicker._setDateFromField(b), $.datepicker._updateAlternate(b), $.datepicker._updateDatepicker(b));
          } catch (a) {
            $.datepicker.log(a);
          }
        return !0;
